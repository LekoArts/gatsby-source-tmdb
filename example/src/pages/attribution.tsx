...
const Attribution: React.FC<PageProps> = () => (
  <Layout>
    <h1>Attribution</h1>
    <p>
    ...
    <p>
      <Link to="https://github.com/grantholle/moviedb-promise">moviedb-promise</Link> for helping with the TS types some
      general concepts around effectively fetching the data.
    </p>
    <p>
